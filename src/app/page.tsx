      ...
      <div className="flex flex-col-reverse items-center justify-center md:flex-row md:justify-start lg:justify-center gap-4 p-4">
        ...
        >
          ...
          <p className="text-center md:text-left">
            Hello there! I'm Thitipong Tapianthong, a student in network
            engineering at King Mongkut's University of Technology North
            Bangkok.
          </p>

          <p className="text-center md:text-left">
            I'm interested in web development and programming. Mainly I use
            React, Next.js, and Tailwind CSS for my projects.
          </p>
        </div>
